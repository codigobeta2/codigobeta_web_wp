...
function twenty_twenty_one_scripts() {
	...
	// Genera una versión basada en la última modificación del archivo style.css
	$theme_version = wp_get_theme()->get( 'Version' ); // Línea existente.
	$style_version = filemtime( get_template_directory() . '/style.css' ); // Línea agregada.
	...
	if ( $is_IE ) {
		...
		wp_enqueue_style( 'twenty-twenty-one-style', get_template_directory_uri() . '/style.css', array(), $style_version );
	}
...
function custom_theme_scripts() {
    wp_enqueue_script(
        ...
        array('jquery'), // Asegúrate de que jQuery se carga antes
        wp_get_theme()->get('Version'),
        true
    );
    ...
    wp_enqueue_script(
        ...
        array('jquery', 'slick-script'), // Dependencia de jQuery y slick.js
        wp_get_theme()->get('Version'),
        true
    );
